# Parameter estimation in the repressilator model using PINNs and DeepXDE (Stable Parameters Region, n = 3 and beta = 5)
...
data = np.load("/Users/bernatcasajuana/github/PINNs_Repressilator/Datasets/Repressilator_3.npz")
...
variables = np.loadtxt("Parameters_Evolution_3.dat")
