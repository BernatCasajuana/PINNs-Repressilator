# Prediction of Repressilator dynamics using PINNs and DeepXDE (Parameters: n = 3 and beta = 10, corresponding to an unstable system with oscillations)
...
np.savez("Your path to folder of choice/Repressilator_U1.npz", t=t, y=x_ode)
