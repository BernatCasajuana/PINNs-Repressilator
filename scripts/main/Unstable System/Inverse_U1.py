# Parameter estimation in the repressilator model using PINNs and DeepXDE (Parameters: n = 3 and beta = 10, corresponding to an unstable system with oscillations)
...
np.savetxt("/Users/bernatcasajuana/github/PINNs_Repressilator/Datasets/Parameters_Evolution_U1.dat", np.array(variable_callback.estimated_params))

# Save in CSV
with open("/Users/bernatcasajuana/github/PINNs_Repressilator/Results/Estimated_Parameters_U1.csv", "w", newline="") as csvfile:
